...
store_continue_4:
	sw $t0,4($t1)
.data
string_const_3: .asciiz "RUN"
.text
	la $t0,string_const_3
...
store_continue_6:
	...
	syscall
	move $t1,$v0
	la $t0,vtable_BigDog  # load vtable address for BigDog
...
store_continue_8:
	sw $t0,4($t1)
.data
string_const_4: .asciiz "RUN"
.text
	la $t0,string_const_4
