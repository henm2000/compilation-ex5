...
main:
	...
	add $t3,$t0,$t1
	li $t9,32767
	ble $t3,$t9,add_no_overflow_18
	li $t3,32767
	j add_done_20
add_no_overflow_18:
	li $t9,-32768
	bge $t3,$t9,add_no_underflow_19
	li $t3,-32768
add_no_underflow_19:
add_done_20:
	li $t1,4
	mul $t1,$t3,$t1
	li $t9,32767
	ble $t1,$t9,mul_no_overflow_21
	li $t1,32767
	j mul_done_23
mul_no_overflow_21:
	li $t9,-32768
	bge $t1,$t9,mul_no_underflow_22
	li $t1,-32768
mul_no_underflow_22:
mul_done_23:
	move $a0,$t1
...
store_continue_25:
	...
	add $t3,$t2,$t1
	li $t9,32767
	ble $t3,$t9,add_no_overflow_26
	li $t3,32767
	j add_done_28
add_no_overflow_26:
	li $t9,-32768
	bge $t3,$t9,add_no_underflow_27
	li $t3,-32768
add_no_underflow_27:
add_done_28:
	li $t1,4
...
load_continue_90:
	lw $t2,16($t0)
	lw $t1,global_LinearAlgebra2
	li $t0,100
	bnez $t2,array_not_null_91
	la $a0,string_invalid_ptr_dref
	li $v0,4
	syscall
	li $v0,10
...
load_continue_102:
	...
	syscall
array_not_null_103:
	bgez $t2,array_index_nonneg_104
	la $a0,string_access_violation
	li $v0,4
	syscall
	li $v0,10
...
load_continue_106:
	...
	syscall
array_not_null_107:
	bgez $t0,array_index_nonneg_108
	la $a0,string_access_violation
	li $v0,4
	syscall
	li $v0,10
...
load_continue_110:
	...
	syscall
array_not_null_111:
	bgez $t0,array_index_nonneg_112
	la $a0,string_access_violation
	li $v0,4
	syscall
	li $v0,10
...
load_continue_122:
	...
	syscall
array_not_null_123:
	bgez $t0,array_index_nonneg_124
	la $a0,string_access_violation
	li $v0,4
	syscall
	li $v0,10
...
array_index_ok_131:
	...
	add $t0,$t0,$t1
	li $t9,32767
	ble $t0,$t9,add_no_overflow_132
	li $t0,32767
	j add_done_134
add_no_overflow_132:
	li $t9,-32768
	bge $t0,$t9,add_no_underflow_133
	li $t0,-32768
add_no_underflow_133:
add_done_134:
	bnez $t2,array_not_null_135
	la $a0,string_invalid_ptr_dref
	li $v0,4
	syscall
	li $v0,10
...
add_done_146:
	...
	syscall
array_not_null_147:
	bgez $t3,array_index_nonneg_148
	la $a0,string_access_violation
	li $v0,4
	syscall
	li $v0,10
